...
SET DEFINE OFF;
Insert into CONTRATACION.NOVEDADES (CON_ID,NOV_CODIGO_DOCUMENTO,NOV_FECHA_INICIO,NOV_FECHA_FIN,NOV_MEDIDA_MANEJO,NOV_TIPO) values ('1','NOV123',to_date('01/01/22','DD/MM/RR'),to_date('01/01/23','DD/MM/RR'),'1','1');
Insert into CONTRATACION.NOVEDADES (CON_ID,NOV_CODIGO_DOCUMENTO,NOV_FECHA_INICIO,NOV_FECHA_FIN,NOV_MEDIDA_MANEJO,NOV_TIPO) values ('2','NOV456',to_date('01/02/22','DD/MM/RR'),to_date('01/02/23','DD/MM/RR'),'2','2');
