...
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.AREA TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.CONTRATO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.CONTRATO_SEGURIDADSOCIAL TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.EMPLEADO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.HABILIDADES TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.HABILIDADES_PERFILCARGO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.MODALIDAD_CONTRATO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.MONEDA TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.NOVEDADES TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.PERFILCARGO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.POSICION TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.POSICION_CONTRATO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.SALARIOS TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.SEDE TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.SEGURIDADSOCIAL TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.TIPO_CONTRATO TO Contralor;
GRANT INSERT, SELECT, UPDATE, DELETE ON Contratacion.TIPO_IDENTIFICACION TO Contralor;

GRANT SELECT ON Contratacion.AREA TO Talento_humano;
GRANT SELECT ON Contratacion.CONTRATO TO Talento_humano;
GRANT SELECT ON Contratacion.CONTRATO_SEGURIDADSOCIAL TO Talento_humano;
GRANT SELECT ON Contratacion.EMPLEADO TO Talento_humano;
GRANT SELECT ON Contratacion.HABILIDADES TO Talento_humano;
GRANT SELECT ON Contratacion.HABILIDADES_PERFILCARGO TO Talento_humano;
GRANT SELECT ON Contratacion.MODALIDAD_CONTRATO TO Talento_humano;
GRANT SELECT ON Contratacion.MONEDA TO Talento_humano;
GRANT SELECT ON Contratacion.NOVEDADES TO Talento_humano;
GRANT SELECT ON Contratacion.PERFILCARGO TO Talento_humano;
GRANT SELECT ON Contratacion.POSICION TO Talento_humano;
GRANT SELECT ON Contratacion.POSICION_CONTRATO TO Talento_humano;
GRANT SELECT ON Contratacion.SEDE TO Talento_humano;
GRANT SELECT ON Contratacion.SEGURIDADSOCIAL TO Talento_humano;
GRANT SELECT ON Contratacion.TIPO_CONTRATO TO Talento_humano;
GRANT SELECT ON Contratacion.TIPO_IDENTIFICACION TO Contralor;